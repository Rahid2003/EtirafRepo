...
async def _onaylama(bot, query):
        ...
        await bot.send_message(Config.ETIRAF_CHANNEL, text=query.message.text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text=LAN.ITIRAF_CHANNEL_TEXT_BUTTON, url=f"https://t.me/{Config.BOT_USERNAME}")]]))
